...
class NavBar extends Component {
    ...
    <nav className="container navbar navbar-expand-lg navbar-light bg-white py-3">
        {/* <a className="navbar-brand" href="#"><img src="../images/logo.png" style={{width:"30px"}} alt="Your LOGO HERE!" /></a> */}
            ...
            <form className="form-inline my-2 my-lg-0">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item active mx-2">
                        <Link className="nav-link " to="#" id="navbar-right-side-home">HOME <span
